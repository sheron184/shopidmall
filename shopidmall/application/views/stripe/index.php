...
<body>
 <p class="d-none" id="price"><?php echo $amount; ?></p>
...
<script src="<?php echo base_url(); ?>/assets/checkout.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>/assets/popper.min.js" type="text/javascript"></script>
-->
